<template>
	<view>
		<!-- 地址 -->
		<navigator url="/ruralPages/address/address?source=1" class="address-section">
			<view class="order-content">
				<u-icon name="map" style="width: 90rpx;text-align: center;display: flex;justify-content: center;" color="#909399" size="44" />
				<view class="cen">
					<view class="top">
