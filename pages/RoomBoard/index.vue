...
export default {
  ...
  onReady(){
     ...
     */
    try{
      let view = uni.createSelectorQuery().in(this).select(".tabToggle");
      ...
      view.fields({
        ...
        // #endif
        this.height = res.windowHeight - res.statusBarHeight - iphoneHeight - data.height
      }).exec();
    }
    catch (err){
      console.log(err)
